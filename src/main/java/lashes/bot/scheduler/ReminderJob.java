...
public class ReminderJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        String messageText = String.format(
                "🌸 *%s*, напоминаем, что вы записаны на наращивание ресниц *%s в %s*.\n\n" +
                        "Ждём вас! 💖\n" +
        ...
        try {
            ...
            log.info("Sent reminder for appointment {} to user {}", appointmentId, userId);
        } catch (Exception e) {
            log.error("Failed to send reminder for appointment {}", appointmentId, e);
        }
    }
}